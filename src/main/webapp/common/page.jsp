...
<script id="pageinateTemplate" type="x-tmpl=mustache" >
    <div class="col-xs-6">
...
<script type="text/javascript">
    var pageinateTemplate = $("#pageinateTemplate").html();
    Mustache.parse(pageinateTemplate);
    ...
    function renderPage(url,total,pageNo,pageSize,currentSize,idElement,callback) {
        ...
        var view = {
            ...
            beforePageNo : pageN0 == 1 ? 1 : (pageNo - 1),
        ...
        $("#" + idElement).html(Mustache.render(pageinateTemplate, view));
